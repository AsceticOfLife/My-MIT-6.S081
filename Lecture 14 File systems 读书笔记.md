...
![img](images/image14/14.png)

结果可能是找到了，也可能是没有找到。如果找到了，那么目录y也会有一个inode编号，假设是251，

![img](images/image14/15.png)
...
![img](images/image14/23.png)

bread函数首先会调用bget函数，bget会为我们从buffer cache中找到block的缓存。让我们看一下bget函数

<img src="images/image14/24.png" alt="img" style="zoom:67%;" />
